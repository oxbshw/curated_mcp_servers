...
|-------|-------------|--------|
| **1mcp/agent** – [github](https://github.com/1mcp-app/agent) | A unified MCP server that aggregates multiple MCP servers into one【998338899745608†L130-L132】. | awesome‑mcp‑servers |
| **MCPJungle** – [github](https://github.com/duaraghav8/MCPJungle) | Self‑hosted registry for enterprise AI agents【998338899745608†L133-L134】. | awesome‑mcp‑servers |
| **MetaMCP (Metatool‑App)** – [github](https://github.com/metatool-ai/metatool-app) | A GUI‑based unified middleware that manages multiple MCP connections【998338899745608†L146-L148】. | awesome‑mcp‑servers |
| **Pipedream MCP Registry** – [github](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) | Connects to over 2,500 APIs with 8,000+ prebuilt tools【998338899745608†L156-L158】. | awesome‑mcp‑servers |
| **WayStation MCP** – [github](https://github.com/waystation-ai/mcp) | Seamlessly connect Claude Desktop and other hosts to popular apps like Notion and Slack【998338899745608†L181-L184】. | awesome‑mcp‑servers |
| **MCPDiscovery** – [github](https://github.com/particlefuture/1mcpserver) | Automatically discover and configure MCP servers on your machine【850734403541532†L47-L50】. | mcp‑servers‑hub |

## Developer Tools & Infrastructure

| Server | Description | Source |
|-------|-------------|--------|
| **1Panel MCP** – [github](https://github.com/1panel-dev/mcp-1panel) | Manage websites, databases, SSL certificates and apps through 1Panel【850734403541532†L51-L54】. | mcp‑servers‑hub |
| **3D Printer MCP** – [github](https://github.com/DMontgomery40/mcp-3D-printer-server) | Interact with 3D printer management systems, manipulate STL files and control printers【850734403541532†L68-L71】. | mcp‑servers‑hub |
| **4o Mini Search MCP** – [github](https://github.com/rebers/4o-mini-search-mcp) | Provides lightweight web search via OpenAI or OpenRouter models【850734403541532†L77-L80】. | mcp‑servers‑hub |
| **4o Image MCP** – [github](https://github.com/antipas/4oimage-mcp) | Connect to the 4o‑image API for generating and editing images【850734403541532†L81-L84】. | mcp‑servers‑hub |
| **A11y MCP** – [github](https://github.com/priyankark/a11y-mcp) | Perform accessibility audits on webpages using axe‑core【850734403541532†L101-L104】. | mcp‑servers‑hub |
| **AnyQuery** – [github](https://github.com/julien040/anyquery) | Query more than 40 apps using SQL with a single binary【998338899745608†L142-L145】. | awesome‑mcp‑servers |

## Art, Culture & Media

| Server | Description | Source |
|-------|-------------|--------|
| **Open Library MCP** – [github](https://github.com/8enSmith/mcp-open-library) | Access book information via the Open Library API【998338899745608†L205-L207】. | awesome‑mcp‑servers |
| **Blender MCP** – [github](https://github.com/ahujasid/blender-mcp) | Work with Blender to generate 3D animations and models【998338899745608†L210-L211】. | awesome‑mcp‑servers |
| **Video Editing MCP** – [github](https://github.com/burningion/video-editing-mcp) | Add, analyze and generate video edits【998338899745608†L212-L214】. | awesome‑mcp‑servers |
| **Discogs MCP** – [github](https://github.com/cswkim/discogs-mcp-server) | Interact with the Discogs music database【998338899745608†L218-L219】. | awesome‑mcp‑servers |
| **Fal MCP Server** – [github](https://github.com/raveenb/fal-mcp-server) | Generate AI images, videos and music using Fal models【998338899745608†L224-L225】. | awesome‑mcp‑servers |

## AI & Data Tools

| Server | Description | Source |
|-------|-------------|--------|
| **AgentQL** – [pipedream](https://mcp.pipedream.com/app/agentql) | Make the Web AI‑ready with AgentQL【750535130624550†L50-L52】. | Pipedream |
| **Agenty** – [pipedream](https://mcp.pipedream.com/app/agenty) | Robotic process automation software【750535130624550†L52-L54】. | Pipedream |
| **AI Textraction** – [pipedream](https://mcp.pipedream.com/app/ai_textraction) | Extract custom entities (names, dates, prices, etc.) from free text【750535130624550†L54-L56】. | Pipedream |
| **Aidbase** – [pipedream](https://mcp.pipedream.com/app/aidbase) | AI‑powered support for your SaaS startup【750535130624550†L59-L60】. | Pipedream |
| **AirOps** – [pipedream](https://mcp.pipedream.com/app/airops) | Build and scale LLM‑powered workflows and chat assistants【750535130624550†L61-L62】. | Pipedream |
| **AITable.ai** – [pipedream](https://mcp.pipedream.com/app/aitable_ai) | Automate data across 6,000+ apps【750535130624550†L65-L66】. | Pipedream |
| **Albus** – [pipedream](https://mcp.pipedream.com/app/albus) | AI‑powered Slack search and web assistant【750535130624550†L67-L68】. | Pipedream |
| **Algomo** – [pipedream](https://mcp.pipedream.com/app/algomo) | Multilingual customer service via generative AI【750535130624550†L74-L75】. | Pipedream |
| **All‑Images.ai** – [pipedream](https://mcp.pipedream.com/app/all_images_ai) | Generate personalized, royalty‑free visuals for projects【750535130624550†L78-L80】. | Pipedream |
